...
from .views import RegisterView, LoginView, UsuariosView, UsuarioDetailView, SuspenderUsuarioView, ActivarUsuarioView, NinoLoginView, HijosPadreView, EstadisticasGeneralesView, EstadisticasHijosPadreView, EstadisticasClaseProfesorView, LogsActividadView
...
urlpatterns = [
    ...
    path('director/logs',               LogsActividadView.as_view()),
