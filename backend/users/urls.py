...
from .views import RegisterView, LoginView, UsuariosView, UsuarioDetailView, SuspenderUsuarioView, ActivarUsuarioView, NinoLoginView, HijosPadreView, EstadisticasGeneralesView, EstadisticasHijosPadreView
